...
#This was part of my plan to break up the main()
#Sadly I did not get that far
#user start menu
#def startmenu(self):
#    print('Holiday Menu')
#    print('===================')
...
def main():
    ...
    while running == True:
        ...
        try:
            ...
            # I am baffled by my failure here
            elif menuchoice == 4:
                print('View Holidays')
                print('===============')
                ...
                if viewweek == '':
                    ...
                    print(listofholidays.viewCurrentWeek())
                
                else:
                    print(f'These are the holidays for {viewyear} week #{viewweek}')
                    print(listofholidays.displayHolidaysInWeek(viewyear, viewweek))
